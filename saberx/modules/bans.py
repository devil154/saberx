...
from saberx.modules.helper_funcs.admin_rights import user_can_ban
from saberx.modules.helper_funcs.alternate import typing_action
from saberx.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
...
from saberx.modules.helper_funcs.extraction import extract_user_and_text
...
SBAN_HANDLER = CommandHandler(
    "sban", sban, pass_args=True, filters=Filters.group)
